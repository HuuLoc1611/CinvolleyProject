 ...
 * @author Admin
 */
@WebServlet(name="PdetailServlet", urlPatterns={"/pdetail"})
public class PdetailServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       List<Product> listPP = d.getRelatedPro(pid);
       ...
       if(sid_raw!=null){
        ...
        List<Product> list2 = d.getPdetailCart();
       List<Comment> listCO = new ArrayList<>();
       DaoComment dc = new DaoComment();
       listCO = dc.get3Comment(0, pid_raw);
