            ...
            <div class="row">
                <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        <div class="row">
                            <div class="col-12">
                                <h2 class="tm-block-title d-inline-block">Delete Product</h2>
                            </div>
                        </div>
                        <div class="row tm-edit-product-row">
                            <div class="col-xl-6 col-lg-6 col-md-12">

                                <form action="deleteproduct" method="post" class="tm-edit-product-form">
                                    <c:forEach items="${requestScope.listP}" var="c">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select
                                                ...
                                                name ="category"
                                                >                       
                                               <option>${requestScope.c.name}</option>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <c:forEach items="${c.list}" var="s">
                                                <input
                                                    <input type="radio" name="size" value="${s.size.sid}" checked                                        
                                                    /> &nbsp;${s.size.name}   
                                            </c:forEach>
